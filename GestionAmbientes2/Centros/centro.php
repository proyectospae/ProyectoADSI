...
<body>
  <div class="margin" id="margin">
   ...
   <div class="margin4" id="margin4">
    <p><a href="insertar.php" id="link1">Registrar Nuevo Centro</a></p>
    <p><a href="CRUD/mostrar.php" id="link1">Mostrar los Centros</a></p>
    <p><a href="actualizar.php" id="link1">Actualizar los datos de los Centros</a></p>
    <p><a href="borrar.php" id="link1">Borrar Centros de formacion</a></p>
