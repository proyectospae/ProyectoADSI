...
<body>
  <div class="margin" id="margin">
   ...
   <div class="margin4" id="margin4">
   	<p><a href="insertar.php" id="link1">Registrar Nueva Jornada</a></p>
   	<p><a href="CRUD/mostrar.php" id="link1">Mostrar las Jornadas</a></p>
   	<p><a href="actualizar.php" id="link1">Actualizar los datos de las Jornadas</a></p>
   	<p><a href="borrar.php" id="link1">Eliminar Jornada</a></p>
