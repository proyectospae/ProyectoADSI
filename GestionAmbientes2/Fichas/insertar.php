...
<form name="form1" method="post" action="CRUD/registrar.php"><br><br>
  <p2 id="p2"><center>Formulario de Registro</center></p2>
      ...
      Fichas: 
      <input type="text" name="fichasnom" id="fichasnom" required="">
      ID del Ambiente: 
      <input type="text" name="IDAmbi" id="IDAmbi" required="">
      Jornada: 
      <input type="text" name="IDjorna" id="IDjorna" required="">

      <input type="submit" name="Guardar" id="Guardar" value="Enviar">
  </table>
</form>
    <p><a href="/ProyectoADSI/GestionAmbientes2/Fichas/fichas.php" id="volver">Volver menu principal</a></p>
  </div>
