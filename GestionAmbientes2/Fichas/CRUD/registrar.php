...
// Consulta en SQL
$query = "INSERT INTO `fichas` (`idfichas`, `fichasNom`, `ambientes_idAmbientes`, `jornadas_idjornadas`) VALUES ('$a', '$b', '$c','$d')";
$z->query($query);
//echo $z;
?>
<p><a href="/ProyectoADSI/GestionAmbientes2/fichas/fichas.php" id="volver"><br>Volver menu principal</a></p>
  </div>
